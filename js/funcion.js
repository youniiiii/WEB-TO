...
/** FIN SECTOR DE LOS AÑOS AUTOMATICA PARA EL FOOTER **/
//obtener el valor de el input del nombre y apellido
const nombre = document.getElementById("nombre");
const apellido = document.getElementById("apellido");
//subir estos datos al sessionStorage
...
//mostrarlo con un console los datos recuperados
console.log(nombre.value);

/**FIN FUNCIONES SESSIONSTORAGE */
